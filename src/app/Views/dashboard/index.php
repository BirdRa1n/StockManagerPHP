<body class="bg-gray-100 min-h-screen">
    <div class="max-w-7xl mx-auto p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="/logout" class="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">Sair</a>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow">
            ...
            <div class="flex gap-4">
                ...
                <a href="produtos.php" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
                    Ver Produtos
                </a>
            </div>
        </div>
